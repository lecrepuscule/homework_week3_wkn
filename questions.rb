...
def select_elements_starting_with_vowel(array)
  array.select{|value| value.start_with?("a", "e", "i", "o", "u")}
end
...
def remove_nils_and_false_from_array(array)
  array.compact.delete_if{|value| value == false}
end
...
def number_of_elements_that_are_palindromes(array)
  array.count{|w| w.reverse == w}
end

# return the shortest word in an array
def shortest_word_in_array(array)
  array.sort{|w1, w2| w1.length <=> w2.length}.first
end

# return the longest word in an array
def longest_word_in_array(array)
  array.sort{|w1, w2| w1.length <=> w2.length}.last
end
...
def add_together_keys_and_values(hash)
  hash.flatten.inject{|sum,v| sum+v}
end
